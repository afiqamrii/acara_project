...
const navItems = [
  ...
  { label: "Conflict Monitor", href: "/admin/conflicts", icon: IconShield },
        ...
        <AnimatePresence initial={false}>
          {(isMobile || !collapsed) && (
            <motion.span
              ...
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
              className="shrink-0 rounded-full bg-indigo-50 px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider text-indigo-600"
            >
              Admin
            </motion.span>
          )}
          ...
          return (
            ...
            >
              ...
              {isActive && (isMobile || !collapsed) && (
                <motion.div
                  layoutId={isMobile ? "mobileAdminActiveIndicator" : "adminActiveIndicator"}
