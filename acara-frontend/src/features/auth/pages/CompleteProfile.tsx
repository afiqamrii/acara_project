        ...
        <div className="grid grid-cols-1 md:grid-cols-5 rounded-3xl overflow-hidden shadow-[0_20px_60px_-20px_rgba(55,65,81,0.35)] bg-white border border-gray-100">
          <aside className="md:col-span-2 bg-gradient-to-br from-[#6C4AB8] to-[#7E57C2] text-white p-8 md:p-10">
            <div className="inline-flex items-center bg-white/15 backdrop-blur px-4 py-2 rounded-full mb-6">
              ...
              />
              <span className="ml-2 text-xs font-semibold tracking-[0.12em]">
                ACCOUNT SETUP
              </span>
            </div>
            ...
            <p className="text-purple-100 text-sm leading-relaxed mb-8">
              Finalize your account details and replace the temporary password
              before accessing the admin panel.
            </p>

            <div className="space-y-3 text-sm">
              <div className="flex items-start gap-3 bg-white/10 rounded-xl p-3">
                <span className="w-5 h-5 mt-0.5 rounded-full bg-white/20 flex items-center justify-center">
                  1
                </span>
          ...
          <section className="md:col-span-3 p-6 sm:p-8 md:p-10">
            <div className="mb-7">
              ...
              <p className="text-sm text-gray-500 mt-1">
                This is required for first-time admin login.
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5" noValidate>
              ...
              <div className="pt-1">
                ...
                <div className="relative">
                  <input
                    className={`w-full px-4 py-3 bg-gray-50 border rounded-xl focus:outline-none focus:ring-2 focus:bg-white transition-all text-sm text-gray-900 placeholder:text-gray-400 pr-12 ${
                      errors.password
                        ? "border-red-500 focus:ring-red-200 focus:border-red-500"
                        : "border-gray-200 focus:ring-[#7E57C2]/20 focus:border-[#7E57C2]"
                    }`}
                ...
                <div className="mt-3 grid grid-cols-1 sm:grid-cols-2 gap-2">
                  <div
                    className={`text-xs rounded-lg px-3 py-2 border ${passwordCriteria.length ? "bg-green-50 border-green-200 text-green-700" : "bg-gray-50 border-gray-200 text-gray-500"}`}
                  >
                    At least 8 characters
                  </div>
                  <div
                    className={`text-xs rounded-lg px-3 py-2 border ${passwordCriteria.upper ? "bg-green-50 border-green-200 text-green-700" : "bg-gray-50 border-gray-200 text-gray-500"}`}
                  >
                    One uppercase letter
                  </div>
                  <div
                    className={`text-xs rounded-lg px-3 py-2 border ${passwordCriteria.lower ? "bg-green-50 border-green-200 text-green-700" : "bg-gray-50 border-gray-200 text-gray-500"}`}
                  >
                    One lowercase letter
                  </div>
                  <div
                    className={`text-xs rounded-lg px-3 py-2 border ${passwordCriteria.number ? "bg-green-50 border-green-200 text-green-700" : "bg-gray-50 border-gray-200 text-gray-500"}`}
                  >
                    One number
                  </div>
                  <div
                    className={`text-xs rounded-lg px-3 py-2 border sm:col-span-2 ${passwordCriteria.special ? "bg-green-50 border-green-200 text-green-700" : "bg-gray-50 border-gray-200 text-gray-500"}`}
                  >
